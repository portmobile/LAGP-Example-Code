...
public class StartActivity extends BaseGameActivity {
	...
	private SharedPreferences audioOptions, scores, eula;
	private SharedPreferences.Editor audioEditor, scoresEditor, eulaEditor;
     ...
     public void showEULA() {
         ...
         if(eulaShown == false){
             ...
             AlertDialog.Builder builder = new AlertDialog.Builder(this)
                     ...
                     .setCancelable(false)
                     .setMessage(message)
                     .setPositiveButton(getString(R.string.accept), new Dialog.OnClickListener() {
                         @Override
                     ...
                     .setNegativeButton(getString(R.string.decline), new Dialog.OnClickListener() {
                         @Override
